...
## <a id="screenshots"></a> $\color{red}\text{Screenshots}$
Trivy Before
<p align="center">
...
## <a id="reflektion"></a> $\color{red}\text{Reflektion}$
...
## <a id="vad-jag-har-gjort"></a> $\color{red}\text{Vad jag har gjort}$
...
## <a id="verktyg"></a> $\color{red}\text{Verktyg}$
**För labben**
* Trivy
* Docker
* Kubernetes
